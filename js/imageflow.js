...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		percentLandscape:   143,            /* Scale landscape format */
		percentOther:       125,            /* Scale portrait and square format */
		...
		xStep:              140             /* Step width on the x-axis in px */
	};
	...
	this.refresh = function()
	{
		...
		thisObject.scrollbarDiv.style.marginLeft = 5.3 + Math.round(thisObject.sliderWidth + ((thisObject.imagesDivWidth - thisObject.scrollbarWidth)/2)) + 'px';
